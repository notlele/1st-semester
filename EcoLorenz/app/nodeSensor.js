...
const cfg = {
    "host": "ecolorenz.database.windows.net",
    "user": "bandtec",
    "pass": "C0derteam",
    "db": "ecolorenz"
};
...
function registrarLeitura(temperatura, umidade) {
	...
	request = new Request(`
	INSERT into sensor (idCasa, localizacao, temperatura, umidade, horario) 
	values (1, 'sala',@temperatura, @umidade, CURRENT_TIMESTAMP);
	`, function(err, linhas) {  
		 if (err) {  
